...
const DEST_CONFIG = {
  nacionales:   { codes: ["MDZ","BRC","IGR","CRD","USH","NQN","SLA","TUC","COR","ROS"], origs: ["EZE","AEP"], meses: 12, dias: range(4,10),  threshold: 0.20 },
  europa:       { codes: ["MAD","LIS","BCN","CDG","FCO","AMS","NRT"],                   origs: ["EZE","SCL","GRU"], meses: 12, dias: range(20,30), threshold: 0.30 },
  norteamerica: { codes: ["MIA","JFK","LAX","ORD","DFW","ATL","CUN"],                   origs: ["EZE","SCL"], meses: 12, dias: range(14,21), threshold: 0.30 },
  latam:        { codes: ["LIM","BOG","MEX"],                                            origs: ["EZE"], meses: 12, dias: range(7,14),  threshold: 0.25 },
};
...
// ══════════════════════════════════════════════════════
// COMPARTIDO — Filtro, Orígenes, Telegram, Formato
// ══════════════════════════════════════════════════════
