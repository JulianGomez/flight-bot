...
// Configuración hardcodeada por tipo de destino
const DEST_CONFIG = {
...
async function searchFlightTP(token, marker, origin, destination, month, durations) {
  ...
  // Duración típica del rango (valor del medio)
  ...
  return {
    ...
    origin,
    destination,
    bookingLink: buildBookingLink(origin, destination, departureDate, marker),
  };
}
